 ...
 */
 $description_from = business_form_get_option('business_form_blog_excerpt_option');
 $description_length = business_form_get_option('business_form_description_length_option');
    ...
    <time class="entry-date published updated" datetime="2018-11-25T04:36:26+00:00"><?php echo get_the_date(); ?></time>
        ...
        <div class="entry-content">
            ...
            <a href="<?php the_permalink(); ?>"
               class="continue-link"><?php esc_html_e('Continue Reading', 'business-form'); ?></a>
